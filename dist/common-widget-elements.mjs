...
const GLOBAL = (() => {
    ...
    if (typeof global !== undef) {
        return global;
    }
    if (typeof self !== undef) {
        return self;
    }
...
/* unused harmony default export */ var _unused_webpack_default_export = (getGlobal);
 ...
 * @return {Object}
 */
function objectExtend(mergeIntoObj, ...mergeObjects) {
...
/* harmony default export */ var jsutils_objectExtend = (objectExtend);
...
const arrayForEach = functionBindCall(runtime_aliases_arr.forEach);
const arrayIndexOf = functionBindCall(runtime_aliases_arr.indexOf);
const arraySplice = functionBindCall(runtime_aliases_arr.splice);

// Logging
const consoleLog = console.log;
const consoleError = console.error || consoleLog;

// Iterators
const SymbolIterator = "undefined" !== typeof Symbol && Symbol.iterator ? Symbol.iterator : "@@iterator";
// EXTERNAL MODULE: external "Set"
var external_Set_ = __webpack_require__(0);
var external_Set_default = /*#__PURE__*/__webpack_require__.n(external_Set_);
...
function objectWatchProp(obj, prop, callback) {
     ...
     */
    const unWatch = destroyWatcher.bind(obj, callback, prop ? obj[OBSERVABLE_IDENTIFIER].props[prop] : obj[OBSERVABLE_IDENTIFIER]);
...
function setupPropInterceptors(obj, prop) {
    ...
    objectDefineProperty(obj, prop, {
        ...
        get() {
            if (TRACKERS.size) {
                TRACKERS.forEach(obj[OBSERVABLE_IDENTIFIER].props[prop].storeCallback, obj[OBSERVABLE_IDENTIFIER].props[prop]);
            }
...
function makeArrayWatchable(arr) {
    ...
    if (!arrCurrentProto[ARRAY_WATCHABLE_PROTO]) {
        ...
        objectDefineProperty(arrProtoInterceptor, "size", {
            ...
            get() {
                if (TRACKERS.size) {
                    TRACKERS.forEach(this[OBSERVABLE_IDENTIFIER].storeCallback, this[OBSERVABLE_IDENTIFIER]);
                }
                return this.length;
            }
        });
...
/* harmony default export */ var src_objectWatchProp = (objectWatchProp);
        ...
        if (ComponentClass.propsDef) {
            objectKeys(ComponentClass.propsDef).forEach(propName => {
                ...
                if (isArray(state.propsDef[propName].aliases)) {
                    const propAliasDef = jsutils_objectExtend({}, ComponentClass.propsDef[propName], { _isAlias: true });
...
//===========================================================================================
const supportsShadyCSS = () => !!getGlobal["a" /* GLOBAL */].ShadyCSS;
...
function prepareComponentTemplate(Component, tagName) {
    ...
    if (supportsShadyCSS()) {
        getGlobal["a" /* GLOBAL */].ShadyCSS.prepareTemplate(getComponentTemplate(Component), tagName);
    }
}
...
function styleComponentInstanceElement(componentInstance) {
    if (supportsShadyCSS()) {
        getGlobal["a" /* GLOBAL */].ShadyCSS.styleElement(componentInstance);
    }
}
 ...
 * @param {HTMLElement} componentInstance
 */
function reStyleComponentInstanceSubtree(componentInstance) {
    if (supportsShadyCSS()) {
        getGlobal["a" /* GLOBAL */].ShadyCSS.styleSubtree(componentInstance);
    }
}
 ...
 *
 */
let ComponentElement_ComponentElement = _fixBabelExtend(class ComponentElement extends HTMLElement {
    constructor(...args) {
    ...
    get props() {
        ...
        objectKeys(propDefinitions).forEach(propName => {
            if (!propDefinitions[propName] || !propDefinitions[propName]._isAlias) {
                ...
                if (propDefinitions[propName].attr && !propDefinitions[propName].boolean && elementHasAttributeForProp(this, propDefinitions[propName])) {
    ...
    emit(eventName, data, eventInit) {
        this.dispatchEvent(new CustomEvent(eventName, jsutils_objectExtend({}, this.constructor.eventInitOptions, eventInit, { detail: data })));
    }
...
/* harmony default export */ var src_ComponentElement = (ComponentElement_ComponentElement);
...
function setupProp(options, Proto, prop, descriptor) {
    ...
    propDef = jsutils_objectExtend(getPropDef(Proto, prop, getter, setter), options);
...
/* harmony default export */ var domutils_domPosition = (domPosition);
 ...
 * popup.show = true;
 */
let Popup_Popup = (_dec = prop_prop({ required: true, attr: true }), _dec2 = prop_prop({ boolean: true }), _dec3 = prop_prop({ boolean: true }), _dec4 = prop_prop({ attr: true }), _dec5 = prop_prop({ attr: true }), (_class = class Popup extends ComponentElement_ComponentElement {
    //-------------------------------------------------------------
    //
    //                                              STATIC MEMBERS
    //
...
}, (_applyDecoratedDescriptor(_class.prototype, "for", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "for"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "show", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "show"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "autoClose", [_dec3], Object.getOwnPropertyDescriptor(_class.prototype, "autoClose"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "my", [_dec4], Object.getOwnPropertyDescriptor(_class.prototype, "my"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "at", [_dec5], Object.getOwnPropertyDescriptor(_class.prototype, "at"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "_handleShowProp", [bind], Object.getOwnPropertyDescriptor(_class.prototype, "_handleShowProp"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "position", [bind], Object.getOwnPropertyDescriptor(_class.prototype, "position"), _class.prototype)), _class));

/* harmony default export */ var src_Popup_Popup = (Popup_Popup);
...
/* harmony default export */ var domutils_domInsertBefore = (domInsertBefore);
// CONCATENATED MODULE: ./src/ContentAccess/ContentAccess.js
var ContentAccess_dec, ContentAccess_dec2, ContentAccess_desc, ContentAccess_value, ContentAccess_class;
 ...
 */
let ContentAccess_ContentAccess = (ContentAccess_dec = prop_prop({ attr: true, boolean: true }), ContentAccess_dec2 = prop_prop({ attr: true, boolean: true }), (ContentAccess_class = class ContentAccess extends ComponentElement_ComponentElement {
    //-------------------------------------------------------------
    //
    //                                              STATIC MEMBERS
    //
...
}, (ContentAccess_applyDecoratedDescriptor(ContentAccess_class.prototype, "block", [ContentAccess_dec], Object.getOwnPropertyDescriptor(ContentAccess_class.prototype, "block"), ContentAccess_class.prototype), ContentAccess_applyDecoratedDescriptor(ContentAccess_class.prototype, "onParent", [ContentAccess_dec2], Object.getOwnPropertyDescriptor(ContentAccess_class.prototype, "onParent"), ContentAccess_class.prototype), ContentAccess_applyDecoratedDescriptor(ContentAccess_class.prototype, "_handleBlock", [bind], Object.getOwnPropertyDescriptor(ContentAccess_class.prototype, "_handleBlock"), ContentAccess_class.prototype)), ContentAccess_class));
...
/* harmony default export */ var src_ContentAccess_ContentAccess = (ContentAccess_ContentAccess);
// CONCATENATED MODULE: ./src/index.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VERSION", function() { return VERSION; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "Popup", function() { return Popup_Popup; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "ContentAccess", function() { return ContentAccess_ContentAccess; });
